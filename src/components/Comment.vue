<template>
  <div class="flex flex-col gap-15 pb-10">
    <div class="flex flex-col" v-for="cmt in commentItems.items" :key="cmt.id">
      <CommentItem :commentItem="cmt" :-head-comment="cmt" @newComment="reloadComment"/>
      <div
    ...
    <Popup v-model:show="showMoreComment" position="bottom" class="h-2/3" round>
      <div class="flex flex-col h-full">
        <div
          ...
          <CommentItem :commentItem="commentPop" :-head-comment="commentPop" @newComment="reloadComment"
                       @showCommentPop="itemCommentPop = true" @closeCommentPop="itemCommentPop = false"/>
        </div>
        <div class="flex flex-col px-15 gap-10 bg-vant-n2 py-10">
          <CommentItem
              ...
              :commentItem="c"
              :-head-comment="commentPop" @showCommentPop="itemCommentPop = true"
