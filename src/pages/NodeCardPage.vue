<template>
  ...
  <div class="flex px-15 pt-10 flex-col gap-10">
    <div class="flex grow justify-between">
      <div class="text-15">节点标题测试没有问题</div>
      <Tag type="primary">进行中</Tag>
    </div>
    <div class="flex gap-10 items-center">
      <Tag plain type="primary" class="shrink-0 h-25">时间</Tag>
      <span class="text-14">2024-02-23 14:00 - 2024-03-01 14:00</span>
    </div>
    <div class="flex gap-10">
      <Tag plain type="primary" class="shrink-0 h-25">信息</Tag>
      <div class="flex flex-col gap-5">
        <div v-for="a in [1, 1]" class="rounded-[5px] bg-vant-n2 text-13 p-5">
          @计科211史诗琪:关于这个信息我必须说一点的是你要注意了哈哈
        </div>
      </div>
    </div>
    <div class="flex gap-10">
      ...
      <div class="flex flex-col gap-5">
        <div
          ...
          @计科211史诗琪:关于这个经验我必须说一点的是你要注意了哈哈
        </div>
      </div>
    </div>
    <div class="flex gap-10">
      ...
      <div class="flex flex-col gap-5">
        <div
          v-for="a in [1, 1, 1]"
          class="rounded-[5px] bg-vant-n2 text-13 p-5">
          @计科211史诗琪:关于这个资源我必须说一点的是你要注意了哈哈
        </div>
      </div>
    </div>
  </div>
